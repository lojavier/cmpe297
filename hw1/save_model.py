...
print("testGen.classes = %s" % (testGen.classes))
print("testGen.class_indices = %s" % (testGen.class_indices))
print("testGen.class_indices.keys() = %s" % (testGen.class_indices.keys()))
print("len(testGen.class_indices.keys()) = %s" % (len(testGen.class_indices.keys())))

# show a nicely formatted classification report
# print(classification_report(testGen.classes, predIdxs, target_names=testGen.class_indices.keys()))
print(classification_report(testGen.classes, predIdxs, labels=[0, 1, 2], target_names=testGen.class_indices.keys()))
