# USAGE
# python train_model.py --dataset vehicles --model vehicles.model --label-bin vehicles.pickle --plot vehicles_plot.png
...
imagePaths = imagePaths[:MAX_IMGS]
...
model = VehicleNet.build(width=64, height=64, depth=3, classes=len(lb.classes_))
...
print("[INFO] serializing network to '{}' and label binarizer...".format(args["model"]))
